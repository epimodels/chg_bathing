...
# Fit delta
delta_fit = ABCFit(config='MRSA_Decolonization_Latent.psc',objective=28.94742,tol=0.05,iterations=22728,parameter='delta',priorhi=1.0,priorlow=0.0)

delta_estimate = delta_fit[:,0][delta_fit[:,2]==1]

numpy.savetxt(''.join(['deltafit_latent_',suffix,'.csv']),delta_estimate,delimiter=',',comments=',')
