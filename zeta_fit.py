...
# Fit zeta
zeta_fit = ABCFit(config='MRSA_Decolonization.psc',objective=22.36691,tol=0.05,iterations=22728,parameter='zeta',priorhi=1,priorlow=0.0)

zeta_estimate = zeta_fit[:,0][zeta_fit[:,2]==1]

numpy.savetxt(''.join(['zetafit_',suffix,'.csv']),zeta_estimate,delimiter=',',comments=',')
