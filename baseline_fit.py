...
MRSA_fit = ABCFit(config='MRSA_Decolonization.psc',objective=39.03,tol=0.05,iterations=22728,priorhi=1.0,priorlow=0)

MRSA_estimate = MRSA_fit[:,0][MRSA_fit[:,2]==1]

numpy.savetxt(''.join(['basefit_',suffix,'.csv']),MRSA_estimate,delimiter=',',comments=',')